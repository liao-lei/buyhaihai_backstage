...
export default class Limittime extends React.Component{
  constructor(props){
    super(props);
    this.state={
  ...
  return (
       <div>
          <Row>
            <Col span={5} offset={10} style={{fontSize:20,color:"red"}}>限时抢购商品录入</Col>
            ...
            <Col span={12} offset={6}>
              <div className="example-input">
                ...
                秒杀时间：<Input size="large" placeholder="秒杀时间" />
              </div>
            </Col>
