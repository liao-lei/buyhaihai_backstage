	...
	var Recogoods = function (_React$Component) {
	  ...
	  function Recogoods(props) {
	    ...
	    _this.state = {
	      data: [],
	      pagination: {},
	      columns: [{ title: '商品名称', dataIndex: 'goods.name', key: 'goods.name' }, { title: '商品现价', dataIndex: 'goods.price', key: 'goods.price' }, { title: '商品原价', dataIndex: 'goods.yprice', key: 'goods.yprice' }, { title: '商品图片', key: 'main_img',
