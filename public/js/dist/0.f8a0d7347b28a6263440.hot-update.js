	...
	var Orderinfo = function (_React$Component) {
	  ...
	  function Orderinfo(props) {
	    ...
	    _this.state = {
	      data: [],
	      pagination: {},
	      columns: [{ title: '收货人', dataIndex: 'users.name', key: 'users.name' }, { title: '电话号码', dataIndex: 'users.phonenumber', key: 'users.phonenumber' }, { title: '收货地址', dataIndex: 'addr', key: 'addr' }, { title: '货物状态', dataIndex: 'type', key: 'type' }, { title: '操作', key: 'operation',
