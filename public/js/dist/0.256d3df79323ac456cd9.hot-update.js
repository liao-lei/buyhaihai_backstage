	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _antd.Row,
	          { style: { border: "1px solid red", height: 700, background: "yellow" } },
	          _react2.default.createElement(
	            _antd.Col,
	            { span: 5, offset: 1 },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backheader = function (_React$Component) {
	  _inherits(Backheader, _React$Component);

	  function Backheader() {
	    _classCallCheck(this, Backheader);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Backheader).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _antd.Row,
	          null,
	          _react2.default.createElement(_antd.Row, { style: { height: 20 } }),
	          _react2.default.createElement(
	            _antd.Col,
	            { span: 22, offset: 1, style: { background: "#33ffcc", height: 80, borderTopLeftRadius: 10, borderTopRightRadius: 10 } },
	            _react2.default.createElement(_antd.Row, { style: { height: 10 } }),
	            _react2.default.createElement(
	              _antd.Col,
	              { span: 4 },
	              _react2.default.createElement("img", { src: "../../img/logo.png", style: { height: 50 } })
	            ),
	            _react2.default.createElement(
	              _antd.Col,
	              { span: 5, offset: 4, style: { fontSize: 30, color: "red", marginTop: 10 } },
	              "后台数据管理界面"
	            ),
	            _react2.default.createElement(
	              _antd.Col,
	              { span: 5, offset: 6, style: { color: "black", marginTop: 20 } },
	              "欢迎",
	              _react2.default.createElement(
	                "span",
	                { style: { color: "red" } },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(258); if (makeExportsHot(module, __webpack_require__(152))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Backheader.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
