	...
	var User = function (_React$Component) {
		...
		function User(props) {
			...
			_this.state = {
				data: [],
				pagination: {},
				columns: [{ title: '用户名', dataIndex: 'username', key: 'username' }, { title: '电子邮箱', dataIndex: 'email', key: 'email' }, { title: '电话', dataIndex: 'phone', key: 'phone' }, { title: '操作', key: 'operation', render: function render(text, record) {
