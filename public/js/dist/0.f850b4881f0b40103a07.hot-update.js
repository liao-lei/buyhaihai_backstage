	...
	var Lookadv = function (_React$Component) {
	  ...
	  function Lookadv(props) {
	    ...
	    _this.state = {
	      data: [],
	      pagination: {},
	      columns: [{ title: '商品名称', dataIndex: 'name', key: 'data.name' }, { title: '商品现价', dataIndex: 'price', key: 'price' }, { title: '商品原价', dataIndex: 'yprice', key: 'yprice' }, { title: '商品图片', key: 'main_img',
	        render: function render(text, record) {
	          return _react2.default.createElement("img", { src: text.main_img ? text.main_img[0] : '' });
	        }
	  ...
	  _createClass(Lookadv, [{
	    ...
	    key: "showGoods",
	    value: function showGoods(curpage) {
	      (0, _ajax2.default)({
	        type: "get",
	        url: "/goods/shows",
