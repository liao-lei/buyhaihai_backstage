...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backright = function (_React$Component) {
	  _inherits(Backright, _React$Component);

	  function Backright(props) {
	    _classCallCheck(this, Backright);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Backright).call(this, props));

	    _this.state = {};
	    return _this;
	  }

	  _createClass(Backright, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _antd.Col,
	            { span: 24, style: { borderLeft: "1px solid #A6A6A6", background: "#BCD2EE", height: 500 } },
	...
	exports.default = Backright;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(258); if (makeExportsHot(module, __webpack_require__(152))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Backright.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Showsusers = function (_React$Component) {
	  ...
	  function Showsusers() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Showsusers).apply(this, arguments));
	  }

	  _createClass(Showsusers, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(_antd.Table, { columns: columns, dataSource: data, pagination: false });
	    }
	  }]);
